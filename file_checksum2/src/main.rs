...
impl Context {
	...
	pub fn update(&mut self, input: &mut Vec<u8>, len:u32) {
...
fn main() {
	...
	let digest = context.do_final();
	println!("md5 is {:x}", ByteBuf(&digest));
}
